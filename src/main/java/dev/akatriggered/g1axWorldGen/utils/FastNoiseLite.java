...
public class FastNoiseLite {
   ...
   public static enum NoiseType {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.NoiseType[] $values() {
         return new FastNoiseLite.NoiseType[]{OpenSimplex2, OpenSimplex2S, Cellular, Perlin, ValueCubic, Value};
      }
   }
   ...
   public static enum RotationType3D {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.RotationType3D[] $values() {
         return new FastNoiseLite.RotationType3D[]{None, ImproveXYPlanes, ImproveXZPlanes};
      }
   }
   ...
   private static enum TransformType3D {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.TransformType3D[] $values() {
         return new FastNoiseLite.TransformType3D[]{None, ImproveXYPlanes, ImproveXZPlanes, DefaultOpenSimplex2};
      }
   }
   ...
   public static enum FractalType {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.FractalType[] $values() {
         return new FastNoiseLite.FractalType[]{None, FBm, Ridged, PingPong, DomainWarpProgressive, DomainWarpIndependent};
      }
   }
   ...
   public static enum CellularDistanceFunction {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.CellularDistanceFunction[] $values() {
         return new FastNoiseLite.CellularDistanceFunction[]{Euclidean, EuclideanSq, Manhattan, Hybrid};
      }
   }
   ...
   public static enum CellularReturnType {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.CellularReturnType[] $values() {
         return new FastNoiseLite.CellularReturnType[]{CellValue, Distance, Distance2, Distance2Add, Distance2Sub, Distance2Mul, Distance2Div};
      }
   }
   ...
   public static enum DomainWarpType {
      ...
      // $FF: synthetic method
      private static FastNoiseLite.DomainWarpType[] $values() {
         return new FastNoiseLite.DomainWarpType[]{OpenSimplex2, OpenSimplex2Reduced, BasicGrid};
      }
   }
